...
|---|---|---|
| **Exchanges** | Limited crypto exchange support | Binance, Gate.io, Bybit, OKX, Coinbase |
...
| **Custom operators** | `BaseOperator` inheritance, 213+ built-in | `QCAlgorithm` class, indicator library |
...
- **[FIELD Protocol](/engine/field-data-principle)**: How multi-exchange data routing works natively
