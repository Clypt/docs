...
| **Non-RL strategies** | Not designed for | 380+ operators (technical, factor, AI) |
...
5. **380+ Pre-built Operators** — A growing instruction set from SMA to LLM scoring, all composable in the same DAG
