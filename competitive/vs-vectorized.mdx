...
1. **Extract your signal logic** into ClyptQ operators (most `ta-lib` indicators have direct equivalents in ClyptQ's 213+ operator library)
...
- **[STATE Principle](/engine/state-principle)**: Portfolio state management missing from vectorized frameworks
