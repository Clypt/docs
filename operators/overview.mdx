...
description: "Complete catalog of 380+ prebuilt operators across 14 roles"
---

## Overview

ClyptQ provides **380+ prebuilt operators** organized across **14 roles**. Every operator follows the same protocol: receive [TaggedArray](/engine/tagged-array) inputs, return TaggedArray outputs. The [StatefulGraph](/engine/stateful-graph) handles all state management, buffering, and execution ordering.
