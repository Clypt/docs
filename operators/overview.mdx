...
description: "Complete catalog of 213+ prebuilt operators across 13 roles"
---

## Overview

ClyptQ provides **213+ prebuilt operators** organized across **13 roles**. Every operator follows the same protocol: receive [TaggedArray](/engine/tagged-array) inputs, return TaggedArray outputs. The [StatefulGraph](/engine/stateful-graph) handles all state management, buffering, and execution ordering.

## Operator Roles

| Role | Count | Purpose | Output |
|---|---|---|---|
| **INDICATOR** | 40+ | Technical indicators (SMA, RSI, MACD, Bollinger) | Numeric values |
| **ALPHA** | 21 | Predictive signals for future returns | Signal in [-1, 1] |
| **FACTOR** | 8 | Cross-sectional systematic exposure | Rank/score per symbol |
| **TRANSFORM** | 20+ | Cross-sectional normalization (ZScore, Rank, Neutralize) | Transformed values |
...
| **METRIC** | 21 | Performance measurement (Sharpe, drawdown) | Rolling or cumulative |
...
| **UTILITY** | 7 | Data routing (Identity, Resample, Merge, Select/Drop) | Transformed data |
...
<CardGroup cols={2}>
  <Card title="Moving Averages" icon="chart-line" href="/operators/indicators/moving-averages">
    SMA, EMA, DEMA, TEMA, WMA, TRIMA, T3, KAMA, MAMA, MA (10)
  </Card>
  <Card title="Momentum" icon="gauge" href="/operators/indicators/momentum">
    RSI, MACD, MOM, ROC, CMO, APO, PPO, STOCH, STOCHRSI, WILLR, ULTOSC, BOP, TRIX (13)
  </Card>
  <Card title="Trend" icon="arrow-trend-up" href="/operators/indicators/trend">
    ADX, AROON, SAR, ICHIMOKU, DI (5)
  </Card>
  ...
  <Card title="Statistics" icon="calculator" href="/operators/indicators/statistics">
    LINEARREG, BETA, CORREL, VAR, TSF, MINMAX (6+)
  </Card>
  <Card title="Candlestick Patterns" icon="candle-holder" href="/operators/indicators/patterns">
    48+ CDL pattern recognizers (CDLDOJI, CDLHAMMER, CDLENGULFING, etc.)
  </Card>
</CardGroup>
...
<CardGroup cols={3}>
  ...
  <Card title="Alpha 101" icon="flask" href="/operators/signals/alpha-101">
    101 formulaic alphas from WorldQuant's Alpha#101 paper
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  <Card title="Scalers" icon="arrows-maximize" href="/operators/transforms/scalers">
    ZScore, Rank, MinMax, L1Norm, Softmax, etc. (10)
  </Card>
...
<CardGroup cols={3}>
  <Card title="Metrics" icon="chart-mixed" href="/operators/metrics">
    Rolling (11) + Accumulative (10) performance metrics
  </Card>
