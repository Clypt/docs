...
|----------|------|----------------|-----------|
| **CDLDOJI** | `INDICATOR` | — | No |
| **CDLHAMMER** | `INDICATOR` | — | No |
| **CDLHANGINGMAN** | `INDICATOR` | — | No |
| **CDLINVERTEDHAMMER** | `INDICATOR` | — | No |
| **CDLSHOOTINGSTAR** | `INDICATOR` | — | No |
| **CDLENGULFING** | `INDICATOR` | — | No |
| **CDLHARAMI** | `INDICATOR` | — | No |
| **CDLMORNINGSTAR** | `INDICATOR` | — | No |
| **CDLEVENINGSTAR** | `INDICATOR` | — | No |
| **CDLMARUBOZU** | `INDICATOR` | — | No |
| **CDL3WHITESOLDIERS** | `INDICATOR` | — | No |
| **CDL3BLACKCROWS** | `INDICATOR` | — | No |
| **CDL2CROWS** | `INDICATOR` | — | No |
| **CDL3INSIDE** | `INDICATOR` | — | No |
| **CDL3LINESTRIKE** | `INDICATOR` | — | No |
| **CDL3STARSINSOUTH** | `INDICATOR` | — | No |
| **CDLABANDONEDBABY** | `INDICATOR` | — | No |
| **CDLADVANCEBLOCK** | `INDICATOR` | — | No |
| **CDLBELTHOLD** | `INDICATOR` | — | No |
| **CDLBREAKAWAY** | `INDICATOR` | — | No |
| **CDLCLOSINGMARUBOZU** | `INDICATOR` | — | No |
| **CDLCONCEALBABYSWALL** | `INDICATOR` | — | No |
| **CDLCOUNTERATTACK** | `INDICATOR` | — | No |
| **CDLDARKCLOUDCOVER** | `INDICATOR` | — | No |
| **CDLDOJISTAR** | `INDICATOR` | — | No |
| **CDLDRAGONFLYDOJI** | `INDICATOR` | — | No |
| **CDLEVENINGDOJISTAR** | `INDICATOR` | — | No |
| **CDLGAPSIDESIDEWHITE** | `INDICATOR` | — | No |
| **CDLGRAVESTONEDOJI** | `INDICATOR` | — | No |
| **CDLHARAMICROSS** | `INDICATOR` | — | No |
| **CDLHIGHWAVE** | `INDICATOR` | — | No |
| **CDLHIKKAKE** | `INDICATOR` | — | No |
| **CDLHIKKAKEMOD** | `INDICATOR` | — | No |
| **CDLHOMINGPIGEON** | `INDICATOR` | — | No |
| **CDLIDENTICAL3CROWS** | `INDICATOR` | — | No |
| **CDLINNECK** | `INDICATOR` | — | No |
| **CDLKICKING** | `INDICATOR` | — | No |
| **CDLKICKINGBYLENGTH** | `INDICATOR` | — | No |
| **CDLLADDERBOTTOM** | `INDICATOR` | — | No |
| **CDLLONGLEGGEDDOJI** | `INDICATOR` | — | No |
| **CDLLONGLINE** | `INDICATOR` | — | No |
| **CDLMATCHINGLOW** | `INDICATOR` | — | No |
| **CDLMATHOLD** | `INDICATOR` | — | No |
| **CDLMORNINGDOJISTAR** | `INDICATOR` | — | No |
| **CDLONNECK** | `INDICATOR` | — | No |
| **CDLPIERCING** | `INDICATOR` | — | No |
| **CDLRICKSHAWMAN** | `INDICATOR` | — | No |
| **CDLRISEFALL3METHODS** | `INDICATOR` | — | No |
| **CDLSEPARATINGLINES** | `INDICATOR` | — | No |
| **CDLSHORTLINE** | `INDICATOR` | — | No |
| **CDLSPINNINGTOP** | `INDICATOR` | — | No |
| **CDLSTALLEDPATTERN** | `INDICATOR` | — | No |
| **CDLSTICKSANDWICH** | `INDICATOR` | — | No |
| **CDLTAKURI** | `INDICATOR` | — | No |
| **CDLTASUKIGAP** | `INDICATOR` | — | No |
| **CDLTHRUSTING** | `INDICATOR` | — | No |
| **CDLTRISTAR** | `INDICATOR` | — | No |
| **CDLUNIQUE3RIVER** | `INDICATOR` | — | No |
| **CDLUPSIDEGAP2CROWS** | `INDICATOR` | — | No |
| **CDLXSIDEGAP3METHODS** | `INDICATOR` | — | No |
