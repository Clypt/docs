...
<AccordionGroup>
  ...
  <Accordion title="2. Operator Layer — 380+ Strategy Components">
    - **[Indicators](/operators/overview)**: SMA, EMA, RSI, MACD, Bollinger, ATR, and 130+ more
  ...
  <Accordion title="4. Data Layer — Multi-Source Integration">
    - **Crypto**: 5 exchanges (Binance, Bybit, Gateio, Coinbase, Kraken)
...
See [Why ClyptQ](/competitive/overview) for the detailed comparison.
