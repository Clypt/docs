...
ClyptQ supports 6 cryptocurrency exchanges for data, backtesting, and live trading:
...
| **OKX** | Yes | Yes (USDT Perp) | 100× | USDT, USDC | Yes |
...
| **Coinbase** | 1h | Every hour | ~42 days | No |
| **Kraken** | 4h | 00:00, 04:00, ... | Full | Yes |

See [Funding Rate Simulation](/backtesting/funding-rates) for how funding is simulated in backtest.
...
| **OKX** | 1m, 5m, 15m, 30m, 1h, 4h, 1d | Full | Parquet |
