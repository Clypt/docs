...
<Note>
**Backtest funding accuracy**: Binance, Bybit, and Gateio have full 8h funding simulation. Kraken's 4h schedule is fully simulated at all 6 daily settlement times. Coinbase funding is not simulated due to limited historical data (`has_funding_rate=False`). See [Funding Rate Simulation](/backtesting/funding-rates) for details.
</Note>
