...
description: "Per-exchange details for Binance, Bybit, Gateio, OKX, Coinbase, and Kraken"
---
...
| **OKX** | Yes | Yes | 100× | USDT, USDC | Full history |
...
| **OKX** | 0.5% | 0.5% | 100% | Inverted (same as Binance) |
...
Professional-grade exchange with Binance-style margin calculation.

**Key characteristics:**
- **Market types**: Spot, USDT Perpetual, COIN Perpetual
- **Quote currencies**: USDT, USDC
- **Max leverage**: 100×
- **Inverted margin ratio**: Same formula as Binance (MMR/Equity × 100)
- **Low MMR**: 0.5% default (aggressive)
...
<Warning>
Coinbase funding rate data is limited to approximately 42 days of history. Long-term backtests on Coinbase perpetual will **not** include funding rate simulation. Consider using Binance or Bybit for historically accurate futures backtests.
</Warning>
...
**Key characteristics:**
- **Market types**: Spot, USD Futures
- **Quote currencies**: USD
- **Max leverage**: 50×
- **Higher MMR**: 2.0%
- **Higher liquidation fee**: 1.5%
- **4-hour funding**: 6 settlements per day (vs standard 3)
