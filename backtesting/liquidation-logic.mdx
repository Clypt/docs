...
| **OKX** | 0.5% | 0.5% | 100% | Inverted | Same style as Binance |
...
<Info>
The **Default MMR** values are Tier 1 (smallest position) rates. In reality, exchanges use tiered MMR where larger positions require higher maintenance margin. ClyptQ uses the Tier 1 default; you can override `maintenance_margin_rate` for more precise simulation.
</Info>
