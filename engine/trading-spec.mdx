...
│   │   ├── exchange / market_type / base_currency
│   │   ├── initial_cash / max_leverage
│   │   ├── credentials: Optional[VenueCredential]
│   │   └── cost_model: Optional[CostModelSpec]
│   ├── execution_price_source: "ohlcv" | "orderbook"
