...
This is critical for the [FIELD](/engine/field-state) system. When a data source hasn't updated:
...
- **[FIELD Data Principle](/engine/field-state)**: FIELD data arrives as TaggedArrays
- **[STATE Principle](/engine/field-state)**: STATE data arrives as TaggedArrays
