...
ClyptQ is a **Trading Commerce platform** — a marketplace where quantitative strategies are independently verified, cross-exchange validated, and deployed with trust between Builders and Buyers.
...
flowchart LR
    ...
    Buyer["Buyer<br><br>Evaluate verified metrics<br>Paper trade 2-4 weeks<br>Deploy live"]
...
<CardGroup cols={3}>
  ...
  <Card title="For Buyers" icon="chart-line" href="/platform/buyer-guide">
    Independently verified metrics, cross-exchange validation, one-click deploy
  </Card>
  <Card title="Marketplace" icon="store" href="/platform/marketplace">
    Cross-exchange validation, independent metric computation, trust mechanism
  </Card>
</CardGroup>
...
| **TradingExecutionSpec** | How to trade | `mode`, `accounts` (with fees, leverage) |
