...
flowchart TB
    ...
    style B fill:#0f2d2b,stroke:#2dd4bf,color:#ccfbf1
    style C fill:#0f2d2b,stroke:#2dd4bf,color:#ccfbf1
    style D fill:#0f2d2b,stroke:#2dd4bf,color:#ccfbf1
    style E fill:#2a1f1f,stroke:#a87171,color:#e8c4c4
```
