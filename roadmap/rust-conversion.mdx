...
┌─────────────────────────────────────────┐
│            Python Layer                  │
│  Strategy research, Jupyter notebooks,   │
│  operator definitions, TradingSpec       │
├─────────────────────────────────────────┤
│          PyO3 Bindings                   │
│  Zero-copy numpy ↔ Rust array bridge     │
├─────────────────────────────────────────┤
│           Rust Core Engine               │
│  Graph execution, RollingBuffer,         │
│  TaggedArray ops, order matching,        │
│  risk management, data I/O               │
└─────────────────────────────────────────┘
```
