...
| TaggedArray operations | `ndarray` + SIMD | Faster element-wise ops |
...
**Target: TBD** (deferred — no Rust code written yet)
...
**Target: TBD** (depends on Phase 1 completion)
...
**Target: TBD** (depends on Phase 2 completion)
...
|---|---|---|
| **Phase 1** | TaggedArray + RollingBuffer | 2025 H2 |
| **Phase 2** | Graph execution engine | 2026 H1 |
| **Phase 3** | Built-in operators (SMA, RSI, Alpha_101) | 2026 H1 |
| **Phase 4** | Order matching + risk engine | 2026 H2 |
| **Phase 5** | Data I/O + storage | 2027 |
