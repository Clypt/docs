...
symbol_source_map = SymbolSourceMap({
    "binance:futures": ["BTC/USDT:USDT", "ETH/USDT:USDT"],
    "bybit:linear": ["BTC/USDT:USDT", "ETH/USDT:USDT"],
})
...
spec = TradingSpec(
    ...
    execution=TradingExecutionSpec(
        accounts=[
            AccountSpec(exchange="binance", market_type="futures", base_currency="USDT", initial_cash=25_000),
            AccountSpec(exchange="bybit", market_type="linear", base_currency="USDT", initial_cash=25_000),
        ],
    ),
    mode="backtest",
)
